...
<div className="sub-heading">
        ...
        <Carousel breakPoints= {breakPoints}>
        <Card position={CardDataGov[0].position}  name= {CardDataGov[0].name} story = {CardDataGov[0].story} source  = {CardDataGov[0].source}/>
        <Card position={CardDataGov[1].position}  name= {CardDataGov[1].name} story = {CardDataGov[1].story} source  = {CardDataGov[1].source}/>
        <Card position={CardDataGov[2].position}  name= {CardDataGov[2].name} story = {CardDataGov[2].story} source  = {CardDataGov[2].source}/>
      <Card/>
      </Carousel>
</div>
